...
class AppTheme {
  ...
  static ThemeData get dark => ThemeData(
        ...
        navigationBarTheme: const NavigationBarThemeData(
          backgroundColor: AppColors.cardDark,
          indicatorColor: Color(0xFF003344),
          iconTheme: WidgetStatePropertyOf(
        ...
        switchTheme: SwitchThemeData(
          thumbColor: WidgetStateProperty.resolveWith(
              (s) => s.contains(WidgetState.selected) ? AppColors.cyan : AppColors.textSecondary),
          trackColor: WidgetStateProperty.resolveWith(
              (s) => s.contains(WidgetState.selected) ? AppColors.cyan.withValues(alpha: 0.3) : const Color(0xFF1E2D4A)),
        ),
